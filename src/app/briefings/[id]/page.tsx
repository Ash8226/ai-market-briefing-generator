  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-8 sm:px-6 sm:py-10">
      <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
        <Link href="/" className="inline-flex items-center gap-2 text-sm font-semibold text-pine hover:text-teal-800"><ArrowLeft aria-hidden="true" size={17} />New briefing</Link>
        <Link href="/saved" className="rounded border border-line bg-white px-3 py-2 text-sm font-medium text-ink hover:border-pine hover:text-pine">Saved briefings</Link>
      </div>
