  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-14">
      <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
        <section>
          <p className="mb-3 text-sm font-semibold uppercase tracking-[0.16em] text-pine">Plain-English market notes</p>
          ...
          <div className="mt-7"><Link href="/saved" className="text-sm font-semibold text-pine hover:text-teal-800">View saved briefings</Link></div>
        </section>
        <BriefingForm />
      </div>
...
function Feature({ icon, title, text }: { icon: ReactNode; title: string; text: string }) {
  return (
    <article className="rounded-lg border border-line bg-white p-5">
      <div className="mb-4 grid h-10 w-10 place-items-center rounded bg-teal-50 text-pine">{icon}</div>
